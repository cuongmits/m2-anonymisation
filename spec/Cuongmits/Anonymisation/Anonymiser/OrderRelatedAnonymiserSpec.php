...
class OrderRelatedAnonymiserSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType(OrderRelatedAnonymiser::class);
    }

    function it_should_run_anonymisation_process_for_every_order_related_anonymisers(
        BaseInterface $entityAnonymiser1,
        BaseInterface $entityAnonymiser2,
        AdapterInterface $connection,
        LoggerInterface $logger
    ...
    function it_should_rollback_anonymisation_process_for_every_order_related_anonymisers_when_something_is_wrong(
        LoggerInterface $logger,
        BaseInterface $entityAnonymiser1,
        BaseInterface $entityAnonymiser2,
        AdapterInterface $connection
